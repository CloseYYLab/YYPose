...
def create_model(num_joints, load_pretrain_weights=True):
    ...
    if load_pretrain_weights:
        ...
        weights_dict = torch.load("./HRNet/hrnet_w32.pth", map_location='cpu')
...
if __name__ == "__main__":
    ...
    # COCO数据集人体关键点信息
    parser.add_argument('--keypoints-path', default="./HRNet/person_keypoints.json", type=str,
    ...
    # 文件保存地址
    parser.add_argument('--output-dir', default='./HRNet/multi_train', help='path where to save')
    # 基于上次的训练结果接着训练
